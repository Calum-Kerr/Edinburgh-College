...
<body>
    ...
    <div id="appCapsule">
        ...
        <div class="header-large-title">
            ...
            <h4 class="subtitle">Previous bookings</h4>
        </div>
		<?php			
			// Get all inactive bookings
			// Create a 'DB' Query
			$get_all_bookings = "SELECT * FROM reservation WHERE reservation_status_id = 3";
						...
						echo	'<div class="col-6">
									<div class="card product-card">
										<div class="card-body">
											...
											<a href="view-booking.php?booking_id='.$all_bookings_arr[$l]['reservation_id'].'" class="btn btn-sm btn-primary btn-block">VIEW</a>
										</div>
									</div>
								</div>
						';
