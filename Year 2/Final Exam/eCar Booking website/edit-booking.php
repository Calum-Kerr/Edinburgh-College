...
<body>
    ...
    <div id="appCapsule">
        ...
        <div class="header-large-title">
            ...
            <h4 class="subtitle">Edit Your eCar Reservation</h4>
        </div>
		<!-- * Page Header -->
        ...
        <div class="section full mt-2 mb-2">
			...
			<div class="section mt-2">
				<form class="needs-validation" action="edit-booking.php?booking_id=<?php echo $booking_id; ?>" method="post" novalidate>
									...
									<div class="custom-select-1">
										<select class="form-control" name="vehicle" id="vehicle" required>
											...
											while($row_vehicle = mysqli_fetch_array($run_get_vehicle)){
												...
												$vehicle_make 	    = $row_vehicle['make'];

												echo'
													<option value="'.$vehicle_id.'">'.$vehicle_make.'</option>
												';
											}
											?>
										</select>
			...
			<?php 	
				...
				// Function to get the campus by id				
				...
				$run_update_reservation = mysqli_query($conn, $update_reservation);
				
				// If the record was successfully updated into 'DB'
				if($run_update_reservation){
					// Close 'DB' connection
					mysqli_close($conn);

					// Show success message to the user
					echo "<script>\n";
					echo "alert('Your reservation has been upadted!');\n";
						
					// Reload the page
					echo "window.location='edit-booking.php?booking_id=".$booking_id.".php';\n";
					echo "</script>";	
				} 
				else {	
